...
const BANNER_RATIO_ON_DESKTOP = 400 / 1120;
const BANNER_RATIO_ON_MOBILE = 140 / 310;
...
const Partner = ({ initData }) => {
  ...
  useEffect(() => {
    const tabs = document.getElementsByClassName("MuiTabScrollButton-root");
  ...
  }, [partnerData, currentTab, isActive]);
